        ...
        try:
            try:
                with self.make_context(prog_name, args, **extra) as ctx:
                    rv = self.invoke(ctx)  # Execute the command logic
    ...
    def invoke(self, ctx: Context) -> t.Any:
        ...
        if not self.chain:
            ...
            with ctx:
                ...
                # Execute the subcommand and process its result
...
# When `greet` is executed, `ctx.invoke(self.callback, **ctx.params)` ensures
# that the `greet` function is called with the correct arguments.
